...
<!---
- Improve appendix treatment
- Eliminate pandoc 2 requirement
...
Distill is an online publication format designed for technical and academic communication. Distill features:
...
Distill articles include a number of options for laying out figures. By default figures span the width of the main article body:
...
See the documentation on [Distill Layout](layout.html)  for details on additional layout options.
