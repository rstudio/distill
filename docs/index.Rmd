...
- A variety of ways to [publish articles](publish_article.html), including support for publishing collections or articles as a [Radix website](publish_website.html).
...
Using Radix requires Pandoc v2.0 or higher. If you are using RStudio then you should use RStudio v1.2 or higher (which comes bundled with Pandoc v2.0). 

You can download a preview release of RStudio v1.2 at <https://www.rstudio.com/rstudio/download/preview/>.
...
Keeping R code and output at 70 characters wide (or less) is recommended for readablity on a variety of devices and screen sizes.

As illustrated above, all of these defaults can be overriden on a chunk-by-chunk basis by specifying chunk options.
