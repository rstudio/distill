...
Using layout classes with [htmlwidgets](http://www.htmlwidgets.org) is very similar to using them with R plots. For example, the following code embeds a Leaflet map:
