...
There are many options for including diagrams within Distill articles, including support for [GraphViz](https://www.graphviz.org/), [D3.js](https://d3js.org/), and SVG files exported from illustration programs like [Inkscape](https://inkscape.org/en/).
