...
Citations are then used in the article body with standard markdown notation, for example: `[@R-knitr]` (which references an id provided in the bibiography). Note that multiple ids (separated by semicolons) can be provided.

The citation is presented inline like this: [@R-knitr] (a number that displays more information on hover). If you have an appendix, a bibliography is automatically created and populated in it.
