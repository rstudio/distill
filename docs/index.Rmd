...
See the documentation on [table display](tables.html) for additional details on the various method available.
...
Footnotes use standard Pandoc markdown notation, for example `^[This will become a hoverable footnote]`. The number of the footnote will be automatically generated. ^[This will become a hover-able footnote]
