...
- alternative to DOI is citation (which just needs a URL)
...
- consider supporting full ISO8601 dates (could we parse them w/o ld?)
   http://www.w3.org/TR/NOTE-datetime
        
- validate that title and description are provided
  
- use lang metadata field rather than locale  
...
- consdier using figure tag? (css advantages?)
- use pandoc filters more?

- jquery based menu that uses alternate theming
