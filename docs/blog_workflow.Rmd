...
You want to have a public GitHub repository that contains the html output of a distill post.
Here's a possible workflow using RStudio IDE and [`usethis`](https://usethis.r-lib.org/), and not taking into account your using private data (that'd you need to [add to .gitignore](https://usethis.r-lib.org/reference/use_git_ignore.html))
