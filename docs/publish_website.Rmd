...
Once you've created your website locally, there are a variety of ways available to publish your site to the web. We cover several options below including [GitHub Pages], [Netlify], [Firebase], [Site44], and [Amazon S3]. 
...
Note also that we used an `icon` for one of the menus, specifying the [Font Awesome](https://fontawesome.com/v4.7.0/) `fa-github` identifier for the GitHub icon (you can use any Font Awesome 4.0 icon).
...
Below we describe several convenient options for Radix website deployment including [GitHub Pages], [Netlify], [Firebase], [Site44], and [Amazon S3]. We'll mostly defer to the documentation provided by the various services, but will note any Radix website specific configuration required.
