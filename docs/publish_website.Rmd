...
You can deploy a Radix website to RStudio Connect from the command line using the `radix::publish_website()` function. For example:
...
You can also publish a Radix website directly to an RStudio Connect server from within the website preview window by clicking the **Publish** button:
