...
For additional documentation on figure cross-references see the [bookdown documentation on figures](https://bookdown.org/yihui/bookdown/figures.html) (Radix uses the bookdown implementation of cross-references under the hood). 
