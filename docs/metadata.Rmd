...
If however your article is not self-contained (it's part of a website or is generated with  `self_contained: false`) then you can include the preview image alongside your document. In this case you still need to specify the root URL where your image will be published to using the `publish_url` field:

```markup
---
title: "JavaScript & D3"
description: Enhance communication with interactive visualizations 
publish_url: https://rstudio.github.io/radix
