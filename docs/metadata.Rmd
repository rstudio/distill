...
If however your article is not self-contained (it's part of a [Radix website](publish_website.html) or is generated with  `self_contained: false`) then you can include the preview image alongside your document. In this case you still need to specify the root URL where your image will be published to using the `base_url` field:
