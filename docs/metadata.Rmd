...
output: distill::distill_article
repository_url: https://github.com/rstudio/distill
compare_updates_url: https://github.com/rstudio/distill/compare/pubv1...master
---
```
...
For example, here's what happens when you include a link to <https://rstudio.github.io/distill/interactivity.html> within a tweet:
