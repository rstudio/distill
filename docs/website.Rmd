...
Blog posts (along with [listing](blog.html#listing-pages) and [custom listing pages](blog.html#custom-listings)) will follow the theme if you use the first option and add it to your `_site.yml`. \#\#\# Custom CSS styles {\#custom-style}
