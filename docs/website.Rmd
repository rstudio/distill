...
The easist way to get started with a website is to call the Radix `create_website()` function, which creates the basic scaffolding for a site with 2 pages (Home and About). For example:
...
The website will be created within the `my-website` sub-directory of the current working directory and will include the following files:
...
If you are using RStudio, you can also create a website using the Radix Website option in the **New Project** dialog:

![](images/create-website.png){width=95% .screenshot}

A new [RStudio Project](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects) for the website will be created and opened.
