...
You can see the full source code for this example at [radix-interactive-document.Rmd](https://github.com/jjallaire/distill/blob/master/inst/examples/radix-interactive-document.Rmd). 
