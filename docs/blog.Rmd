...
The easist way to get started with a blog is to call the Radix `create_blog()` function, which creates the basic scaffolding for a blog (2 pages, Home and About, as well as a simple welcome post).
...
The blog will be created within the `my-blog` sub-directory of the current working directory and will include the following files:
...
If you are using RStudio, you can also create a website using the Radix Blog option in the **New Project** dialog:

![](images/create-blog.png){width=95% .screenshot}

A new [RStudio Project](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects) for the blog will be created and opened.


### Configuration

After you've created the blog scafoolding, there are a couple of additional configuration items you'll want to add to your `_site.yml` so that it's easier to share content on the blog via RSS and social networks like Twitter:
