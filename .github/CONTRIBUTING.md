...
We welcome contributions to the **distill** package. 
...
1.  [Fork](https://github.com/rstudio/distill/fork) the repository and make your changes in a new branch specific to the PR. It is ok to edit a file in this repository using the `Edit` button on Github if the change is simple enough.
